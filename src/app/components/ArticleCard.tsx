    ...
    <div>
      <article className="shadow my-4 flex flex-col">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
          ...
          <Link href={`articles/${article.id}`} className="text-slate-900 text-3xl font-bold hover:text-gray700 pb-4">
            {article.title}
          </Link>
          <p className="text-sm pb-3 text-slate-900">Published on {new Date(article.createdAt).toLocaleString('ja-JP')}</p>
